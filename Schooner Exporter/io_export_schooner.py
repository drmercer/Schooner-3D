...
bl_info = {
    "name": "Schooner3D data format",
    "author": "",
    "version": (),
    "blender": (2, 5, 8),
    "api": 37702,
    "location": "File > Export > Schooner3D (.xml)",
    "description": "Export Schooner3D mesh data (.xml, .raw)",
    "warning": "",
    "wiki_url": "",
    "tracker_url": "",
...
class Schooner3DExporterSettings:
    def __init__(self,
                 context,
                 XMLPath,
                 RawFilePath,
...
class SchoonerExporter(bpy.types.Operator):
    """Export Schooner3D mesh data (.xml, .raw)"""

    bl_idname = "export.schooner3D"
    bl_label = "Schooner3D"
    ...
    def execute(self, context):
        ...
        Config = Schooner3DExporterSettings(context,
                                         FilePath,
...
def menu_func(self, context):
    self.layout.operator(SchoonerExporter.bl_label, text="Schooner3D (.xml)")
